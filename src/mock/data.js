...
export const projectsData = [
  {
    ...
    info: 'This site was created for a clients fitness shop. An online e-commerce site made with React, Redux, MongoDB, JavaScript, HTML & CSS.',
    info2: '',
  ...
  {
    id: nanoid(),
    img: './videos/CodeHeroesProject.mp4',
    title: 'Code Heroes Quest',
    info: 'A full story text-based web game. Code Fellows 401 JavaScript Final Project. Built using React, JavaScript, Socket.io, Express, chalk, jest, HTML, CSS, Inquirer and Inkarnate.',
    info2: '',
  ...
  },
  {
    ...
    title: 'My Quick Pick',
    info: 'A application that is designed to allow people to better tailor their lotto quick picks to a more specified range. Built with React.js, JavaScript, HTML, CSS, Node.js and node-sass.',
    info2: '',
